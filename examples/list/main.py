...
from nice_droplets.elements.item_label import ItemLabel
        ...
        with dui.list(bordered=True, padding=True):
            ...
            with dui.item():
                with dui.item_section():
                    ...
                    ItemLabel('Single line item')
                    ItemLabel('Secondary line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.', caption=True)
                with dui.item_section(side=True, top=True):
                    ItemLabel('5 min ago', caption=True)

            ui.separator().classes('q-my-sm')
            ItemLabel('List Header', header=True)
            ...
            with dui.item():
                ...
                with dui.item_section():
                    ItemLabel('Single line item')
                    ItemLabel('Secondary line text. Lorem ipsum dolor sit amet, consectetur adipiscit elit.', caption=True, lines=2)
                with dui.item_section(side=True, top=True):
                    ItemLabel('5 min ago', caption=True)
